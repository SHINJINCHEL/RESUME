...
## 소개
![프로필이미지](![image]([images/증명사진.jpg](https://github.com/SHINJINCHEL/RESUME/blob/e787ac6982601ad93819aa0c6476a5c9f71ccd9b/images/%EC%A6%9D%EB%AA%85%EC%82%AC%EC%A7%84.jpg)))
- 이름: 신진철
- 군필여부: 의무경찰로 복무완료
- 취미: 야구보기, 달리기, 여행, 영화보기
...
1. 안되면 될 때까지 합니다.
- 프로젝트를 진행하다가 문제가 발생하면 해결할 수 있을 때까지 계속해서 시도해봅니다.
- 시간이 오래걸릴지언정 방향이 맞다면 주저하지 않고 계속합니다.
...
위와 같은 이유로 이 기술자는 저희 회사에서 함께 일했으면 하기 때문에, 다른회사에서 채용하지 않았으면 좋겠습니다.
